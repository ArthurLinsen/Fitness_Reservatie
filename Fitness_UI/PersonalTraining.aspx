    ...
    <form id="formPersonalTraining" runat="server">
        ...
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="personaltraining">
            <div class="w3-twothird">
                ...
                <p>
                    Vind je het lastig om gewicht te verliezen? Gewicht bij te komen? Of je six-pack te creëren? Dan ben je bij
            Personal Training aan het correcte einde. Samen met een personal trainer ga je gefocust te werkt aan je 
            doelstellingen.
                </p>
            </div>
            <div class="w3-third w3-center">
                <asp:Image ID="imgPersonalTraining" runat="server" ImageUrl="/Images/PersonalTraining.jpg" Style="max-height: 300px;" />
            </div>
        </div>
