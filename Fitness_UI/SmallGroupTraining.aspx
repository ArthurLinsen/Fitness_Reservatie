    ...
    <form id="formsmallGroupTraining" runat="server">
        ...
        <div class="w3-row-padding w3-padding-64 w3-theme-l1" id="work">
            <div class="w3-twothird">
                ...
                <p>
                    <b>Wat is een Small Group training?</b> Een Small Group bestaat uit maximaal 5 personen. Door de 
            ...
            op kleine groepen en de focus ligt op conditie en functioneel trainen.
                </p>
                <br />
                <h3>Wat doe je in een Small Group training?</h3>
                <br />
                <asp:ListBox ID="lbxSGTGeeft" runat="server" class="w3-theme-l1">
                    <asp:ListItem Text="white">Cardio training</asp:ListItem>
                    <asp:ListItem>Krachttraining</asp:ListItem>
                </asp:ListBox>
                <br />
                <p>
                    De trainingen zijn gericht op alle spiergroepen maar ook op de lichaamshouding, flexibilieit en stabiliteit
            tijdens het trainen
                </p>
                <br />
                <asp:ListBox ID="lbxAssortimentSGT" runat="server" class="w3-theme-l1">
                ...
                <p>
                    Iedereen die graag in groepsverband traint is geschikt voor Small Group Training. Maar ook degene die 
            graag de extra uitdaging heeft van een persoonlijke training. Ook voor mensen die na hun Personal 
            Training begeleiding willen blijven houden.
                </p>
            </div>
            <div class="w3-third w3-center">
                <asp:Image ID="imgSmallGroupTraining" runat="server" ImageUrl="/Images/SmallGroupTraining.jpg" Style="max-height: 300px;" />
            </div>
        </div>
